...
Our third plot will compare the top 25 grossing movies comparing the adjusted and non-adjusted revenues.
...
Finally our fourth plot will display trend lines for each genre's inflation adjusted revenue over time.
